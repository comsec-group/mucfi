...
yosys find_fwd_mux_selects -register-read-signals ${REGISTER_READ_SIGNALS} -forwarding-signals ${FORWARDING_OUTPUTS} -register-write-signals ${REGISTER_WRITE_SIGNALS} -pc-signals ${PC_SIGNALS}
