...
checker chk_no_taint_ever();
  ...
  as_no_taint_ever_u_ex__instret_t0: assert property(!u_ex__instret_t0);
  as_no_taint_ever_u_ex__regwr_data_t0: assert property(!u_ex__regwr_data_t0);
  as_no_taint_ever_u_ex__regwr_en_t0: assert property(!u_ex__regwr_en_t0);
  as_no_taint_ever_u_ex__regwr_pending_later_t0: assert property(!u_ex__regwr_pending_later_t0);
  as_no_taint_ever_u_ex__regwr_sel_t0: assert property(!u_ex__regwr_sel_t0);
  as_no_taint_ever_u_ex__state_t0: assert property(!u_ex__state_t0);
  ...
  as_no_taint_ever_u_if__state_t0: assert property(!u_if__state_t0);
  as_no_taint_ever_u_ex__u_csr___2528_: assert property(!u_ex__u_csr___2528_);
  as_no_taint_ever_u_ex__u_csr___2532_: assert property(!u_ex__u_csr___2532_);
  as_no_taint_ever_u_ex__u_csr__core_interrupt_t0: assert property(!u_ex__u_csr__core_interrupt_t0);
  as_no_taint_ever_u_ex__u_csr__csr_data_t0: assert property(!u_ex__u_csr__csr_data_t0);
  as_no_taint_ever_u_ex__u_csr__csr_wr_vld_t0: assert property(!u_ex__u_csr__csr_wr_vld_t0);
  ...
  as_no_taint_ever_u_ex__u_csr__state_t0: assert property(!u_ex__u_csr__state_t0);
  as_no_taint_ever_u_ex__u_csr__trap_handle_t0: assert property(!u_ex__u_csr__trap_handle_t0);
  as_no_taint_ever_u_ex__u_csr__trap_jump_t0: assert property(!u_ex__u_csr__trap_jump_t0);
  as_no_taint_ever_u_id__u_hcu__rpend_t0: assert property(!u_id__u_hcu__rpend_t0);
  as_no_taint_ever_u_if__u_rf___2406_: assert property(!u_if__u_rf___2406_);
  as_no_taint_ever_u_if__u_rf___3286_: assert property(!u_if__u_rf___3286_);
  as_no_taint_ever_u_if__u_rf__reg_rs1_t0: assert property(!u_if__u_rf__reg_rs1_t0);
  as_no_taint_ever_u_if__u_rf__reg_rs2_t0: assert property(!u_if__u_rf__reg_rs2_t0);
  as_no_taint_ever_u_if__u_rf__reg_vld_t0: assert property(!u_if__u_rf__reg_vld_t0);
  ...
  as_no_taint_ever_u_ex__u_csr__u_hpmcounter0__count_vld_t0: assert property(!u_ex__u_csr__u_hpmcounter0__count_vld_t0);
  ...
  as_no_taint_ever_u_ex__u_csr__u_hpmcounter1__count_vld_t0: assert property(!u_ex__u_csr__u_hpmcounter1__count_vld_t0);
endchecker