...
yosys update_condition -read-from-signals "cpuregs" -signal_name "cpuregs_rs2" -verbose


# Important to simplify the update condition
yosys opt -purge

yosys write_verilog -sv -attr2comment /data/kceesay/workspace/mucfi/verification/picorv32_ift/yosys_passes/design_uc_regrd2_from_reg.v
