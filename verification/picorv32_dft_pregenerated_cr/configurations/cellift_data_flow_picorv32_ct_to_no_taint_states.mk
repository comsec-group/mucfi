##############################################################################################
# Instruction taint, multiple taints allowed



# DESIGN_FILE   = designs/picorv32_$(FAST_MUL).sv
DESIGN_FILE   = designs/picorv32_cellift_data_flow.sv
...
# VERIF_FILE = formal/scripts/launchers/verif_cadence.tcl
# TASK_FILE = formal/scripts/tasks/picorv32_ct_instr_all_no_taint_states.tcl
VERIF_FILE = ../common/formal/scripts/launchers/verif_cadence.tcl
TASK_FILE = ../common/formal/scripts/tasks/ct_instr_all_no_taint_states.tcl
