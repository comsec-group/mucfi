...
yosys update_condition -signal_name "\\i_pipeline.i_gprs.rs1_data" -verbose


# Important to simplify the update condition
yosys opt -purge

yosys write_verilog -sv -attr2comment /data/kceesay/workspace/mucfi/verification/scarv_dft/yosys_passes/design_uc_rs1.v
