...
yosys update_condition -signal_name "\\cpuregs_rs1" -verbose


# Important to simplify the update condition
yosys opt -purge

yosys write_verilog -sv -attr2comment /data/kceesay/workspace/mucfi/verification/picorv32_dft/yosys_passes/design_uc_rs1.v
