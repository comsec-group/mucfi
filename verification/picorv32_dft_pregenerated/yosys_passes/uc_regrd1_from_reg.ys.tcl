...
yosys update_condition -read-from-signals "cpuregs" -signal_name "\\cpuregs_rs1" -verbose


# Important to simplify the update condition
yosys opt -purge

yosys write_verilog -sv -attr2comment /data/kceesay/workspace/mucfi/verification/picorv32_dft/yosys_passes/design_uc_regrd1_from_reg.v
